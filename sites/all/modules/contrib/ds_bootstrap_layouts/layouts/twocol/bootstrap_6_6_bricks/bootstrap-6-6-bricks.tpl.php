...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($top) : ?>
    <div class="row">
      <<?php print $top_wrapper; ?> class="col-md-12 <?php print $top_classes; ?>">
        <?php print $top; ?>
  ...
  <?php if ($topleft || $topright) : ?>
    <div class="row">
      <<?php print $topleft_wrapper; ?> class="col-md-6 <?php print $topleft_classes; ?>">
        <?php print $topleft; ?>
      </<?php print $topleft_wrapper; ?>>
      <<?php print $topright_wrapper; ?> class="col-md-6 <?php print $topright_classes; ?>">
        <?php print $topright; ?>
  ...
  <?php if ($bottom) : ?>
    <div class="row">
      <<?php print $bottom_wrapper; ?> class="col-md-12 <?php print $bottom_classes; ?>">
        <?php print $bottom; ?>
